"""Generate index.json for allowed files, ignoring specified extensions."""
...
def main(ignored_extensions: List[str]) -> None:
    files_to_download = []
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate index.json for allowed files, ignoring specified extensions."
    )
