...
const SidebarItem = ({ icon, title, onClick }: SidebarItemProps) => (
  <li>
    <button
      onClick={onClick}
      className="w-full flex items-center py-2 px-3 text-sm text-gray-1 hover:bg-gray-1 hover:text-primary-9 rounded-md"
    >
          ...
          <aside className="fixed top-0 right-0 z-40 w-64 h-full overflow-y-auto transition-transform bg-gray-12 p-4">
            ...
            <nav>
              <ul className="space-y-1">
                ...
                <div className="border-t-2 border-gray-1 my-2"></div>
